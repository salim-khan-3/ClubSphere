...
//   const handleCreateClick = () => {
//     navigate("/dashboard/manager/create_club");
//   };
...
// const handleDeleteClick = async (id) => {
//   // Sweet confirm (optional, but better UX)
//   const confirmDelete = window.confirm(
//     "Are you sure you want to delete this club?\nThis action cannot be undone. All members, events, and payments related to this club will be permanently removed."
//   );

//   if (!confirmDelete) return;

//   try {
//     // Firebase ID token নেওয়া
//     const token = await user.getIdToken();
...
//     // Optimistic UI update: React Query cache থেকে club remove করা
//     queryClient.setQueryData(["myclubs", user?.email], (oldData) => {
//       if (!oldData) return [];
//       return oldData.filter((club) => club._id !== id);
//     });

//     // অথবা invalidate করে refetch করতে পারো
...
//                   <button
//                     onClick={() => handleEditClick(club._id)}
//                     className="flex-1 cursor-pointer py-2 rounded-xl bg-amber-400 text-black font-medium hover:bg-amber-500 shadow-md hover:shadow-lg transition-all duration-300"
//                   >
//                     Edit
//                   </button>
...
//                   <button
//                     onClick={() => handleDeleteClick(club._id)}
//                     className="flex-1 cursor-pointer py-2 rounded-xl bg-red-500 text-white font-medium hover:bg-red-600 shadow-md hover:shadow-lg transition-all duration-300"
//                   >
//                     Delete
//                   </button>
//                 </div>
